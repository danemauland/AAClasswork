...
def craiglockhart_to_sighthill
  ...
  FROM stops stopa
  JOIN routes a ON a.stop_id = stopa.id
  join routes b ON (a.company = b.company AND a.num = b.num)
  JOIN stops stopb ON b.stop_id = stopb.id
  JOIN routes c ON stopb.id = c.stop_id
  JOIN routes d ON (c.company = d.company AND d.num = c.num)
  join stops stopc ON d.stop_id = stopc.id
